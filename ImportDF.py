...
def processArchive(fields, pathImport):
    ...
    for filename in all_filesSI:
        ...
        iter_csv = pd.read_csv(filename, index_col=None, encoding="UTF-8",header=0,dtype=str, sep = ',',decimal=',',iterator=True, chunksize=10000, usecols = fields )
